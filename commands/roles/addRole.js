...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("addrole")
    .setDescription(
      "Adds a role to user(s) with link to a csv/txt file with list of all the usernames"
    )
    ...
    .addStringOption((option) =>
      option
        .setName("file_url")
        .setDescription(
          'The url of the csv/txt with list of users as "username#1234", one per line'
        )
    )
