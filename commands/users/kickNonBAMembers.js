...
const MAIN_GUILD_ID = DiscordUtil.getMainGuildId();
...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const mainGuild = DiscordUtil.getAllGuilds([MAIN_GUILD_ID], interaction)[0];

        const getNonBAMembers = () => {
            let nonBAMemberIds = [];
        ...
        const [userIds, mentions] = getNonBAMembers();
        if (userIds.length > 0) {
